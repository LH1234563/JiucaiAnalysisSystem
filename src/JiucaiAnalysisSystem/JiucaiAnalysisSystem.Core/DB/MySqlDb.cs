...
public class MySqlDb
{
    ...
    public bool CreateDatabase()
    {
        try
        {
            ...
            // 创建stock_inventory表的SQL命令
            // string createTableQuery =
            //     $"CREATE TABLE `{config.DbName}`.`stock_inventory` (" +
            ...
            //     $"UNIQUE KEY uk_date_code (trade_date, stock_code),INDEX idx_code_date (stock_code, trade_date)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='A股股票历史行情数据'";
